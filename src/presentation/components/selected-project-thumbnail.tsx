...
interface SelectedProjectThumbnailProps {
  project: Project;
  href: string;
}

const SelectedProjectThumbnail: React.ForwardRefExoticComponent<
  SelectedProjectThumbnailProps & RefAttributes<HTMLAnchorElement>
> = forwardRef<HTMLAnchorElement, SelectedProjectThumbnailProps>(
  ({ project, href }, ref) => {
...
SelectedProjectThumbnail.displayName = "SelectedProjectThumbnail";

export default SelectedProjectThumbnail;
